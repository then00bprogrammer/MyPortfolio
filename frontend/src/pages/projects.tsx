...
const projects = () => {
  ...
  return (
    <VStack w="full" minHeight={['90vh','85vh']} marginTop={['10vh','15vh']}  spacing={0} bg={useColorModeValue('white','black')}>
      <Flex w={`calc(100vw - 12px)`} h={['90vh','85vh']}  bgSize='contain' bgRepeat='no-repeat' bgImage={useColorModeValue('./pencil.jpg','')} flexDir={['column-reverse','row']}> 
        <VStack
          w={['100%','50%']}
          h="full"
          color="black"
          ...
          spacing={0}
        >
          <Heading size={['2xl','3xl']} mb="2.5vh" color={useColorModeValue('gray.700','yellow.100')}>
            PROJECTS
          </Heading>
          <Text fontSize={['md','xl']} color={useColorModeValue('gray.600','gray.400')} mb="2.5vh">
        ...
        <Flex w={['100%','50%']} h={['50%','100%']} alignItems="center" justifyContent="center">
